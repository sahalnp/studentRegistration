...
urlpatterns = [
    ...
    path("products/edit/<uuid:id>/", views.admin_edit_product, name="admins_edit_product"),
    path("products/delete/<uuid:id>/", views.admin_delete_product, name="admins_delete_product"),
    path("account/", views.admin_profile, name="admins_account"),
    path("products/detail/<uuid:id>/", views.admin_detail_products, name="admins_detail_products"),
]
